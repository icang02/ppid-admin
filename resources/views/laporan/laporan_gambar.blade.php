                        ...
                        <div class="card-body table-border-style">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('admin_add_laporan_akses') }}"
                                                ...
                                                <div class="custom-file">
                                                    <input name="gambar[]" type="file" class="custom-file-input"
                                                        id="gambar" accept=".jpg,.jpeg,.png" multiple>
                                                    <label class="custom-file-label" for="gambar">Select more
                                                        image...</label>
                            ...
                            <button href="{{ route('admin_laporan_gambar_delete', $item->id) }}"
                              ...
                              <i class="fas fa-edit"></i> Edit</button>
                                                    ...
                                                    <span>
                                                        <a href="{{ route('admin_laporan_gambar_delete', $item->id) }}"
