                        ...
                        <div class="row-table">
                            <div class="col-sm-6 card-body br">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 text-md-center">
                                        <h5>{{ $sumBerkala }}</h5>
                                        <span>Total Informasi Berkala</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 text-md-center">
                                        <h5>{{ $sumSetiapSaat }}</h5>
                                        <span>Total Informasi Setiap Saat</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row-table">
                            <div class="col-sm-6 card-body br">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 text-md-center">
                                        <h5>{{ $sumSertaMerta }}</h5>
                                        <span>Total Informasi Serta Merta</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 text-md-center">
                                        <h5>{{ $sumBerita }}</h5>
                                        <span>Total Berita & Informasi PPID</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                  ...
                  <div class="col-sm-8 text-md-center">
                    ...
                    <div class="card flat-card widget-purple-card">
                        <div class="row-table">
                            ...
                            <div class="col-sm-9">
                                <h4>Ke Website</h4>
                                <h6 onclick="return window.open('https://ppid.uho.ac.id', '_blank')"
                ...
                <div class="col-md-12 col-xl-4">
                    <div class="card support-bar overflow-hidden">
                        <div class="card-body pb-0">
                            <h2 class="m-0">
                                {{ $sumBerkala + $sumSetiapSaat + $sumSertaMerta }}
                            </h2>
                            <span class="text-c-blue">Total Informasi PPID</span>
                            <p class="mb-3 mt-3">Informasi yang telah dipublikasikan oleh Pejabat Pengelola Informasi dan
                                Dokumentasi
                                (PPID) Universitas Halu Oleo.</p>
                        </div>
                        <div id="support-chart"></div>
                        <div class="card-footer bg-primary text-white">
                            <div class="row text-center">
                                <div class="col">
                                    <h4 class="m-0 text-white">{{ $sumBerkala }}</h4>
                                    <span>Berkala</span>
                                </div>
                                <div class="col">
                                    <h4 class="m-0 text-white">{{ $sumSetiapSaat }}</h4>
                                    <span>Setiap Saat</span>
                                </div>
                                <div class="col">
                                    <h4 class="m-0 text-white">{{ $sumSertaMerta }}</h4>
              ...
              <div class="review-block">
                <div class="row">
                  ...
                  <div class="col">
                    ...
                    <a href="#!"><i class="feather icon-star f-18 text-muted"></i></a>
                    <p class="m-t-15 m-b-15 text-muted">Lorem Ipsum is simply dummy text of the printing and typesetting
